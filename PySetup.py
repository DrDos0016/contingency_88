...
script = "gerry.py"  # Starting .py or .pyw script
dest_file = "Contingency 88"   # Final name of .exe file
dest_folder = "Contin88" # Final folder for the files
icon_file = "data//icon.png"  # Icon file. Leave blank for the pygame icon.
...
dll_excludes = ["w9xpopen.exe", "msvcr71.dll"]            # excluded dlls ["w9xpopen.exe", "msvcr71.dll"]
