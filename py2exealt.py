...
class BuildExe:
    def __init__(self):
        #Name of starting .py
        self.script = "gerry.py"
 
        #Name of program
        self.project_name = "Contingency 88"
        ...
        #Auhor of program
        self.author_name = "Dr. Dos"
        self.author_email = "doctordos@gmail.com"
        self.copyright = "Copyright (c) 2011"
 
        #Description
        self.project_description = "Contingency 88"
 
        #Icon file (None will use pygame default icon)
        self.icon_file = "data//icon.png"
 
        #Extra files/dirs copied to game
        self.extra_datas = ["freesansbold.ttf", "SDL.dll", "SDL_ttf.dll", "libfreetype-6.dll", "zlib1.dll"] #This was originally blank but causing segfaults
        #self.extra_datas = ["freesansbold.ttf"] #This was originally blank but causing segfaults
